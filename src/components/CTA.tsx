  ...
  return (
    <section id="contact" className="py-20 px-4 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="bg-card border-2 border-border rounded-3xl p-8 md:p-10 shadow-2xl hover:shadow-[0_0_50px_rgba(251,146,60,0.15)] transition-all duration-500">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select>
                <SelectTrigger id="event-type" className="h-14 text-base">
