...
const CTA = () => {
  return (
    <section id="contact" className="py-20 sm:py-28 bg-gradient-to-b from-muted/10 to-background">
        ...
        <div className="bg-card border-2 border-border rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl hover:shadow-[0_0_50px_rgba(251,146,60,0.15)] transition-all duration-500">
          <form className="space-y-4 sm:space-y-6">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="John Doe" className="h-12 sm:h-14 text-sm sm:text-base" />
            </div>
