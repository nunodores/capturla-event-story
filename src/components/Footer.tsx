        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Making your events more interactive and memorable. Custom-built for every special occasion.
            </p>
            <a 
              href="/submit-review"
              className="inline-block text-sm font-medium bg-gradient-to-r from-orange-600 via-pink-600 to-rose-600 text-transparent bg-clip-text hover:underline"
            >
