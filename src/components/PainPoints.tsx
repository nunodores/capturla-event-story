...
const PainPoints = () => {
  return (
    <section className="py-20 sm:py-28 px-4 bg-gradient-to-b from-muted/10 to-background">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {solutions.map((solution, index) => {
            ...
            return (
              ...
              >
                <div className={`inline-flex p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-gradient-to-br ${solution.gradient} mb-4 sm:mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
                ...
                <div className={`absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-br ${solution.gradient} opacity-0 group-hover:opacity-10 blur-xl transition-opacity -z-10`} />
              </div>
            );
          })}
        </div>
