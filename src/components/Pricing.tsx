        ...
        <div className="max-w-5xl mx-auto mb-8 sm:mb-12">
          <div className="relative p-6 sm:p-8 md:p-12 lg:p-16 rounded-2xl sm:rounded-3xl border-2 border-border bg-gradient-to-br from-card to-muted/20 hover:shadow-2xl transition-all duration-500">
            <div className="absolute top-0 right-4 sm:right-8 transform -translate-y-1/2">
              <span className="px-3 sm:px-6 py-1.5 sm:py-2 rounded-full bg-gradient-to-r from-orange-400 via-pink-400 to-rose-400 text-white text-xs sm:text-sm font-bold shadow-lg">
                RECOMMENDED
              </span>
            </div>
